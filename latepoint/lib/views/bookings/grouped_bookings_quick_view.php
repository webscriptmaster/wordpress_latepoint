...
<div class="latepoint-lightbox-content">
	<div class="grouped-bookings-main-info">
		...
		<div class="gb-capacity">
			<div
				class="gbc-label"><?php echo __('Booked:', 'latepoint') . ' <span>' . sprintf(__('%d of %d', 'latepoint'), $total_attendies, $booking->service->capacity_max) . '<span>'; ?></div>
			<div class="booked-percentage">
				<div class="booked-bar"
				     style="width: <?php echo OsServiceHelper::get_percent_of_capacity_booked($booking->service, $total_attendies); ?>%;"></div>
			</div>
		</div>
	</div>
		...
		<?php foreach ($group_bookings as $group_booking) { ?>
			<div class="gb-booking" <?php echo OsBookingHelper::quick_booking_btn_html($group_booking->id); ?>>
				...
				<div class="gbb-avatar"
				     style="background-image: url(<?php echo $group_booking->customer->get_avatar_url(); ?>)"></div>
	...
	<div class="add-booking-to-group-box-wrapper">
		<div
			class="os-add-box add-booking-to-group-box" <?php echo OsBookingHelper::quick_booking_btn_html(false, ['start_time' => $group_booking->start_time,
