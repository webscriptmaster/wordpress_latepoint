...
<div class="os-wizard-desc"><?php _e('These will be your default work hours for all your locations, agents and services. You can set custom hours for each agent, service or location in LatePoint admin panel.', 'latepoint'); ?></div>
