...
<a href="<?php echo OsRouterHelper::build_link(OsRouterHelper::build_route_name('dashboard', 'index')); ?>" class="os-wizard-complete-btn latepoint-btn latepoint-btn-outline latepoint-btn-lg">
	<span><?php _e('Open Dashboard', 'latepoint'); ?></span>
