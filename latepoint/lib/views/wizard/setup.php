<div class="os-wizard-setup-w step-<?php echo $current_step; ?>">
	...
	<div class="os-wizard-setup-i">
	    ...
	    <div class="os-wizard-footer">
	      ...
	      <a href="#" data-route-name="<?php echo OsRouterHelper::build_route_name('wizard', 'next_step'); ?>" class="latepoint-btn latepoint-btn-lg os-wizard-next-btn"><span><?php _e('Next', 'latepoint'); ?></span> <i class="latepoint-icon latepoint-icon-arrow-right"></i></a>
	    </div>
		</div>
	</div>
</div>