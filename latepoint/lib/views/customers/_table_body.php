    ...
    <tr>
      ...
      <td>
        <a class="os-with-avatar" href="<?php echo OsRouterHelper::build_link(OsRouterHelper::build_route_name('customers', 'edit_form'), array('id' => $customer->id) ) ?>">
          ...
          <span class="os-name"><?php echo $customer->full_name; ?></span>
        </a>
      </td>
      <td><?php echo $customer->phone; ?></td>
      <td style="max-width: 220px; overflow: scroll;"><?php echo $customer->email; ?></td>
      ...
      ?>
      <td><?php echo $customer->get_total_bookings_count(true); ?></td>
      <td><?php echo ($next_booking) ? $next_booking->nice_start_datetime : __('n/a', 'latepoint'); ?></td>
      <td><?php echo ($next_booking) ? $next_booking->time_left : '<span class="time-left is-past">'.__('Past', 'latepoint').'</span>'; ?></td>
